...
(define (tip AmountOfBill PercentToTip)
  (cond
    [(< AmountOfBill 0) "Amount of bill is negative."]
    [(or (< PercentToTip 0) (> PercentToTip 1.0)) 
     "Percent to tip is not between 0.0 and 1.0."]
    [else (* AmountOfBill PercentToTip)]))
